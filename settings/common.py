"""Django settings for Multi Tenant Django Application project.
...
APPS_DIR = ROOT_DIR.path('multi_tenant_django_application')
...
# ------------------------------------------------------------------------------
REST_FRAMEWORK = {
    'DEFAULT_PAGINATION_CLASS': 'multi_tenant_django_application.base.api.pagination.PageNumberPagination',
    'PAGE_SIZE': 30,
    ...
    'DEFAULT_AUTHENTICATION_CLASSES': (
        ...
        'multi_tenant_django_application.users.auth.backends.UserTokenAuthentication',

        # Mainly used for api debug.
        'rest_framework.authentication.SessionAuthentication',
    ),
    'EXCEPTION_HANDLER': 'multi_tenant_django_application.base.exceptions.exception_handler',
}
...
SITE_NAME = env("SITE_NAME", default='Multi Tenant Django Application')
...
FRONTEND_SITE_NAME = env('FRONTEND_SITE_NAME', default='Multi Tenant Django Application')
...
# URL CONFIGURATION
# ------------------------------------------------------------------------------
ROOT_URLCONF = 'multi_tenant_django_application.urls'
...
DEFAULT_FROM_EMAIL = env('DEFAULT_FROM_EMAIL',
                         default='abc@shanky.xyz')
EMAIL_SUBJECT_PREFIX = env('EMAIL_SUBJECT_PREFIX', default='[Multi Tenant Django Application] ')
...
DATABASES = {
    'default': env.db('DATABASE_URL', default='postgres://localhost/multi_tenant_django_application'),
}
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            ...
            'context_processors': [
                'multi_tenant_django_application.base.context_processors.site_settings',
...
CSRF_FAILURE_VIEW = 'multi_tenant_django_application.base.views.csrf_failure'
...
LOGGING = {
    ...
    'loggers': {
        ...
        'multi_tenant_django_application': {
            'handlers': ['console'],
            'level': 'INFO',
            'propagate': False,
        },
...
def get_release():
    import multi_tenant_django_application
    release = multi_tenant_django_application.__version__
    return release
